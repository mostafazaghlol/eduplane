package com.eltamiuz.eduplane.Adapters;
...
import com.eltamiuz.eduplane.Activities.CoursesItemActivity;
import com.eltamiuz.eduplane.Activities.ShowingContent;
...
//                Toast.makeText(view.getContext(), ""+String.valueOf(course.getFile()), Toast.LENGTH_SHORT).show();
    ...
    private String geturl(String file, String type) {
        if(type.equals("pdf")){
            return "http://drive.google.com/viewerng/viewer?embedded=true&url="+"http://edu-plane.com/edu/public/images/subjects/"+file;
        }else if(type.equals("video")){
            return "http://edu-plane.com/edu/public/images/subjects/"+file;
